...
PARCOURS_FICHIER = Path(__file__).parent / 'datas' / "parcours.2009.csv"              # no;km;parcours
CALENDRIER_FICHIER = Path(__file__).parent / 'datas' / "2023.calendrier.velo.csv"     # date;grand;moyen;petit;mois
...
calendar.extra.append(ContentLine(
    name="X-WR-CALDESC",
    value=f"Calendier des sorties classiques 2023 {cal_name}"
))
calendar.extra.append(ContentLine(
    name="LOCATION",
